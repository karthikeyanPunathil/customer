...
/**
 * REST controller for managing {@link com.diviso.graeshoppe.customer.domain.UniqueCustomerID}.
 */
@RestController
@RequestMapping("/api")
public class UniqueCustomerIDResource {
    ...
    /**
     * {@code POST  /unique-customer-ids} : Create a new uniqueCustomerID.
     *
     * @param uniqueCustomerIDDTO the uniqueCustomerIDDTO to create.
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new uniqueCustomerIDDTO, or with status {@code 400 (Bad Request)} if the uniqueCustomerID has already an ID.
    ...
    /**
     * {@code PUT  /unique-customer-ids} : Updates an existing uniqueCustomerID.
     *
     * @param uniqueCustomerIDDTO the uniqueCustomerIDDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated uniqueCustomerIDDTO,
     * or with status {@code 400 (Bad Request)} if the uniqueCustomerIDDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the uniqueCustomerIDDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<UniqueCustomerIDDTO> updateUniqueCustomerID(@RequestBody UniqueCustomerIDDTO uniqueCustomerIDDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, uniqueCustomerIDDTO.getId().toString()))
            .body(result);
    }

    /**
     * {@code GET  /unique-customer-ids} : get all the uniqueCustomerIDS.
     *

     * @param pageable the pagination information.

     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of uniqueCustomerIDS in body.
     */
    ...
    /**
     * {@code GET  /unique-customer-ids/:id} : get the "id" uniqueCustomerID.
     *
     * @param id the id of the uniqueCustomerIDDTO to retrieve.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the uniqueCustomerIDDTO, or with status {@code 404 (Not Found)}.
     */
    ...
    /**
     * {@code DELETE  /unique-customer-ids/:id} : delete the "id" uniqueCustomerID.
     *
    ...
    /**
     * {@code SEARCH  /_search/unique-customer-ids?query=:query} : search for the uniqueCustomerID corresponding
     * to the query.
     *
