...
import com.diviso.graeshoppe.customer.repository.FavouriteStoreRepository;
import com.diviso.graeshoppe.customer.repository.search.FavouriteStoreSearchRepository;
...
import com.diviso.graeshoppe.customer.service.mapper.FavouriteStoreMapper;
...
/**
 * Integration tests for the {@link FavouriteStoreResource} REST controller.
 */
@SpringBootTest(classes = {CustomerApp.class, TestSecurityConfiguration.class})
public class FavouriteStoreResourceIT {
     ...
     *
     * @see com.diviso.graeshoppe.customer.repository.search.FavouriteStoreSearchRepositoryMockConfiguration
     */
    @Autowired
     ...
     * if they test an entity which requires the current entity.
     */
    public static FavouriteStore createUpdatedEntity(EntityManager em) {
        FavouriteStore favouriteStore = new FavouriteStore()
